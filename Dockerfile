...
# Copy workspace package (npm workspaces create symlinks in node_modules
...
# npm workspaces symlink: node_modules/@serval/core -> ../../packages/serval-core
# Without this, Node.js cannot resolve @serval/core imports at runtime
